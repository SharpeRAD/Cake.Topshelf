...
// Define directories.
var buildDir = "./src/Topshelf/bin/" + configuration;
var buildTestDir = "./src/Topshelf.Tests/bin/" + configuration;
...
// Package
var zipPackage = buildResultDir + "/Cake-Topshelf-v" + semVersion + ".zip";
...
{
    // Addin
    CopyFileToDirectory(buildDir + "/Cake.Topshelf.dll", binDir);
    CopyFileToDirectory(buildDir + "/Cake.Topshelf.pdb", binDir);
    CopyFileToDirectory(buildDir + "/Cake.Topshelf.xml", binDir);
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.Topshelf.nuspec", new NuGetPackSettings
    {
        Version = version,
    ...
    .Does(() =>
{
    ...
    // Push the package.
    var package = nugetRoot + "/Cake.Topshelf." + version + ".nupkg";
